...
city_update_args.add_argument("name", type=str, required=True, help="Please enter your desired city")
city_update_args.add_argument("temp", type=int, required=True, help="Please enter your desired temp")
city_update_args.add_argument("weather", type=str, required=True, help="Please enter your desired weather")
city_update_args.add_argument("people", type=int, required=True, help="Please enter your desired people")
